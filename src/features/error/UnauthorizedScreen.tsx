            ...
            <div className="grid gap-8 lg:grid-cols-[1.25fr_0.75fr] lg:items-start">
              ...
              <div className="grid grid-cols-1 gap-3">
                ...
                <div className="rounded-2xl border border-brand-navy/10 bg-white p-4">
                  <p className="text-[10px] font-bold uppercase tracking-widest text-brand-muted">What to do next</p>
                  <p className="mt-2 text-sm text-brand-muted">
                    Check whether the role has the correct module grant, or return to the last accessible dashboard and continue there.
                  </p>
                </div>
              </div>
            </div>
